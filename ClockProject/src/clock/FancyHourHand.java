...
/**
 * Create the fancy hour hands of a clock
 *
 * @author Adam Bartholomew
 *         February - March, 2013
 */
public class FancyHourHand
{
    /** Constructor
     * 
     ...
     */
    public FancyHourHand(int centerX, int centerY, int length, java.awt.Color color)
    {
    ...
    private long angle;
    private static final int CIRCLES_DIAMETER = 10;
